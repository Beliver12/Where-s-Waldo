...
export const Play = () => {
  ...
  const handleClick = (e) => {
    ...
    if (window.scrollY) {
      ...
      console.log((y / e.target.clientHeight) * 100) 
      console.log((x / e.target.clientWidth) * 100);
    } else {
      ...
      setWidth(e.target.clientWidth);
      setHeight(e.target.clientHeight);
      console.log((300 / e.target.clientWidth) * 100);
      console.log(
        Math.trunc((16.447368421052634 * e.target.clientWidth) / 100),
      );
     console.log((y / e.target.clientHeight) * 100)
      console.log((x / e.target.clientWidth) * 100);
    }
  ...
  return (
    <>
      ...
      <Start start={isActive} setIsActive={setIsActive} setImage={setImage} />
